...
public class ProductPriceForOrderRecord extends UpdatableRecordImpl<ProductPriceForOrderRecord> implements Record6<UInteger, UInteger, BigDecimal, UInteger, Timestamp, Timestamp> {
     ...
     */
    public void setPricePerProduct(BigDecimal value) {
        set(2, value);
    }
     ...
     */
    @Override
    public Row6<UInteger, UInteger, BigDecimal, UInteger, Timestamp, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row6<UInteger, UInteger, BigDecimal, UInteger, Timestamp, Timestamp> valuesRow() {
     ...
     */
    @Override
    public ProductPriceForOrderRecord value3(BigDecimal value) {
     ...
     */
    @Override
    public ProductPriceForOrderRecord values(UInteger value1, UInteger value2, BigDecimal value3, UInteger value4, Timestamp value5, Timestamp value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ProductPriceForOrderRecord(UInteger productId, UInteger orderId, BigDecimal pricePerProduct, UInteger quantity, Timestamp createdAt, Timestamp updatedAt) {
        super(ProductPriceForOrder.PRODUCT_PRICE_FOR_ORDER);
