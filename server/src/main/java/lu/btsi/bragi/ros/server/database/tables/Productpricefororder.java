...
public class Productpricefororder extends TableImpl<ProductpricefororderRecord> {
    ...
    private static final long serialVersionUID = 1008780825;
     ...
     */
    public final TableField<ProductpricefororderRecord, Timestamp> CREATED_AT = createField("created_at", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.inline("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>ros.ProductPriceForOrder.updated_at</code>.
     */
    public final TableField<ProductpricefororderRecord, Timestamp> UPDATED_AT = createField("updated_at", org.jooq.impl.SQLDataType.TIMESTAMP, this, "");
