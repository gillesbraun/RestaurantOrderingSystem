...
public class Productallergen extends TableImpl<ProductallergenRecord> {
    ...
    private static final long serialVersionUID = -1389820659;
     ...
     */
    public final TableField<ProductallergenRecord, Timestamp> CREATED_AT = createField("created_at", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.inline("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>ros.ProductAllergen.updated_at</code>.
     */
    public final TableField<ProductallergenRecord, Timestamp> UPDATED_AT = createField("updated_at", org.jooq.impl.SQLDataType.TIMESTAMP, this, "");
